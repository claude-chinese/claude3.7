...
1.  选择模型： 可选择 Claude 3.7 Sonnet 或 Opus 版本
...
1.  选择版本： 登录后选择 Claude 3.7 Sonnet 或 Opus

1.  开始对话： 输入问题，畅享原版智能对话
...
1.  叠加态：量子系统可以同时存在于多个状态，直到被测量。

1.  量子纠缠：两个量子比特可以关联在一起，无论相距多远，改变一个会立即影响另一个。
...
1.  添加新站点：如果您知道其他可靠的Claude镜像站点，欢迎提交PR添加

1.  分享使用技巧：欢迎分享您使用Claude 3.7的独特技巧和经验

1.  完善文档：帮助我们改进文档，使其更加清晰和易于理解
